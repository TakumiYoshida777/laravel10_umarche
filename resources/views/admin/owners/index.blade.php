                        ...
                        <div class="container px-5 mx-auto">
                            ...
                            <div class="flex justify-end mb4">
                                <button onclick="location.href='{{ route('admin.owners.create') }}'"
                                    class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg mb-4">新規登録する</button>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-3">
                                                ...
                                                class="text-white bg-indigo-500 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-600 rounded text-lg">更新する</button>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
